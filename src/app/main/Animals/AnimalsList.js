...
let counter = 0;
//
// function createData(name, species, fat, carbs, protein, phone, microchip) {
//     counter += 1;
//     return {id: counter, name, calories, fat, carbs, protein, phone, microchip};
// }
...
const rows = [
    ...
    {id: 'breed', numeric: true, disablePadding: false, label: 'Breed'},
    ...
    {id: 'microchip', numeric: true, disablePadding: false, label: 'Microchip'},
];
                                ...
                                .map(n => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{n.species}</TableCell>
                                            <TableCell align="right">{n.breed}</TableCell>
                                            <TableCell align="right">{n.age}</TableCell>
                                            <TableCell align="right">{n.size}</TableCell>
                                            <TableCell align="right">{n.social}</TableCell>
                                            <TableCell align="right">{n.accommodation}</TableCell>
                                            <TableCell align="right">{n.tag}</TableCell>
                                            <TableCell align="right">{n.microchip}</TableCell>
                                        </TableRow>
                                    );
                                })}
                            {emptyRows > 0 && (
